...
public class LotogolMatchesFragment extends SherlockFragmentActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		actionBar.setTitle("Lotogol - Média simples de gols");
		
		LotecaResults result = (LotecaResults) getIntent().getParcelableExtra("lotecaResults");
		
		mContext = LotogolMatchesFragment.this;
		...
		if (result.isSerieB()) {
			...
			new LotecaGraphsGeneratorAsync(this, new int[] { Color.GREEN, Color.RED }, new String[] { "GOLS PRÓ", "GOLS CONTRA"},
					result, "gols").execute();
